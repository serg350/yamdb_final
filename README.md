...
[![API for YaMDB project workflow](https://github.com/serg350/yamdb_final/actions/workflows/yamdb_workflow.yml/badge.svg?branch=master)](https://github.com/serg350/yamdb_final/actions/workflows/yamdb_workflow.yml)
...
### Ссылка на сайт
Проект был запущен и доступен по [адресу](http://sergeyaqua.ddns.net).
...
```bash
git clone https://github.com/serg3502873/yamdb_final.git
```
